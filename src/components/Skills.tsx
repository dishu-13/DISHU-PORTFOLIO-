...
export default function Skills() {
  ...
  return <section id="skills" className="py-24 px-4 md:px-6 relative">
      <div className="container mx-auto max-w-6xl" ref={ref}>
        ...
        duration: 0.6
          ...
          <h2 className="text-3xl md:text-4xl font-medium mb-3 text-primary">
            Skills & Expertise
          </h2>
        ...
        <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-6" variants={containerVariants} initial="hidden" animate={isInView ? "visible" : "hidden"}>
          ...
          return <motion.div key={category.title} variants={itemVariants} whileHover={{
            y: -5,
            scale: 1.02
