...
import { ExternalLink, Github, TrendingUp, Trash2, Home, Wine } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <motion.a
              ...
              className="group relative p-8 rounded-3xl card-glass overflow-hidden hover-lift cursor-pointer"
            >
