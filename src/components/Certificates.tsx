...
const certificates = [
  { title: 'Google Analytics Certification', issuer: 'Google', date: 'December 2025', image: googleAnalyticsCert },
  { title: 'AI-Powered Performance Ads Certification', issuer: 'Google Ads', date: 'December 2025', image: googleAiAdsCert },
  { title: 'NCC Certificate "C" Examination', issuer: 'Ministry of Defence, India', date: '2024', image: nccCert },
...
export default function Certificates() {
  ...
  return (
    <section id="certificates" className="py-32 px-4 relative">
